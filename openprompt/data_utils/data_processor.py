...
class DataProcessor:
    ...
    def get_train_examples(self, data_dir: Optional[str] = None,**kwargs) -> List[InputExample]:
        """
    ...
    def get_dev_examples(self, data_dir: Optional[str] = None,**kwargs) -> List[InputExample]:
        ...
        """
        return self.get_examples(data_dir, "dev",**kwargs)
    ...
    def get_test_examples(self, data_dir: Optional[str] = None,**kwargs) -> List[InputExample]:
        ...
        """
        return self.get_examples(data_dir, "test",**kwargs)
    ...
    @abstractmethod
    def get_examples(self, data_dir: Optional[str] = None, split: Optional[str] = None,**kwarg) -> List[InputExample]:
